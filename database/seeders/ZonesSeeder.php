...
class ZonesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $zoneData = [
            ...
            [
                ...
                'states' => [
                    [
                        'name' => 'Adamawa',
                        'lgas' => ['Demsa', 'Fufore', 'Ganaye', 'Gireri', 'Gombi', 'Guyuk', 'Hong', 'Jada', 'Lamurde', 'Madagali', 'Maiha', 'Mayo-Belwa', 'Michika', 'Mubi North', 'Mubi South', 'Numan', 'Shelleng', 'Song', 'Toungo', 'Yola North', 'Yola South'],
                    ],
                    [
                        'name' => 'Bauchi',
                    ...
                    [
                        'name' => 'Gombe',
                        'lgas' => ['Akko', 'Balanga', 'Billiri', 'Dukku', 'Kaltungo', 'Kwami', 'Shomgom', 'Funakaye', 'Gombe', 'Nafada/Bajoga', 'Yamaltu/Delta'],
                    ],
                    [
                        'name' => 'Taraba',
            ...
            [
                ...
                'states' => [
                    [
                        'name' => 'Abia',
                        'lgas' => ['Aba North', 'Aba South', 'Arochukwu', 'Bende', 'Ikwuano', 'Isiala-Ngwa North', 'Isiala-Ngwa South', 'Isuikwato', 'Obingwa', 'Ohafia', 'Osisioma', 'Ugwunagbo', 'Ukwa East', 'Ukwa West', 'Umuahia North', 'Umuahia South', 'Umu-Nnochi'],
                    ],
                    [
                        'name' => 'Anambra',
                    ...
                    [
                        'name' => 'Ebonyi',
                        'lgas' => ['Abakaliki', 'Afikpo South', 'Afikpo North', 'Onicha', 'Ohaozara', 'Ishielu', 'lkwo', 'Ezza', 'Ezza South', 'Ohaukwu', 'Ebonyi', 'Ivo'],
                    ],
                    [
                        'name' => 'Enugu',
                        'lgas' => ['Enugu South', 'Igbo-Eze South', 'Enugu North', 'Nkanu', 'Udi Agwu', 'Oji-River', 'Ezeagu', 'IgboEze North', 'Isi-Uzo', 'Nsukka', 'Igbo-Ekiti', 'Uzo-Uwani', 'Enugu East', 'Aninri', 'Nkanu East', 'Udenu'],
                    ],
                    [
                        'name' => 'Imo',
                        'lgas' => ['Aboh-Mbaise', 'Ahiazu-Mbaise', 'Ehime-Mbano', 'Ezinihitte', 'Ideato North', 'Ideato South', 'Ihitte/Uboma', 'Ikeduru', 'Isiala Mbano', 'Isu', 'Mbaitoli', 'Ngor-Okpala', 'Njaba', 'Nwangele', 'Nkwerre', 'Obowo', 'Oguta', 'Ohaji/Egbema', 'Okigwe', 'Orlu', 'Orsu', 'Oru East', 'Oru West', 'Owerri-Municipal', 'Owerri North', 'Owerri West'],
                    ],
                ],
            ],
            [
                ...
                'states' => [
                    ...
                    [
                        'name' => 'Bayelsa',
                        'lgas' => ['Brass', 'Ekeremor', 'Kolokuma/Opokuma', 'Nembe', 'Ogbia', 'Sagbama', 'Southern Jaw', 'Yenegoa'],
                    ],
                    [
                        'name' => 'Cross-River',
                    ...
                    [
                        'name' => 'Edo',
                        'lgas' => ['Esan North-East', 'Esan Central', 'Esan West', 'Egor', 'Ukpoba Central', 'Etsako Central', 'Igueben', 'Oredo', 'Ovia SouthWest', 'Ovia South-East', 'Orhionwon', 'Uhunmwonde', 'Etsako East', 'Esan South-East'],
                    ],
                    [
                        'name' => 'Rivers',
            ...
            [
                ...
                'states' => [
                    [
                        'name' => 'Ekiti',
                        'lgas' => ['Ado', 'Ekiti-East', 'Ekiti-West', 'Emure/Ise/Orun', 'Ekiti South-West', 'Ikare', 'Irepodun', 'Ijero', 'Ido/Osi', 'Oye', 'Ikole', 'Moba', 'Gbonyin', 'Efon', 'Ise/Orun', 'Ilejemeje'],
                    ],
                    [
                        'name' => 'Lagos',
        ...
        foreach ($zoneData as $zoneDatum) {
            ...
            foreach ($zoneDatum['states'] as $stateDatum) {
                $state = $zone->states()->create([
                    'name' => $stateDatum['name'],
                ]);

                foreach ($stateDatum['lgas'] as $lgaName) {
                    $state->lgas()->create([
                        'name' => $lgaName,
                    ]);
                }
