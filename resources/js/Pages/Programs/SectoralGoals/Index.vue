...
watch([search, perPage, sortBy, sortOrder], () => {
    ...
    searchTimeout.value = setTimeout(() => {
        router.get('/programs/sectoral-goals', {
            search: search.value,
...
const deleteGoal = (goalId) => {
    if (confirm('Are you sure you want to delete this sectoral goal?')) {
        router.delete(`/programs/sectoral-goals/${goalId}`, {
            preserveScroll: true
        })
    }
}
...
<template>
    <BeLayout>
        <Head title="Sectoral Goals" />

        <div class="row">
            <div class="col-lg-12">
                <h5 class="mt-4 fw-400">Sectoral Goals Management</h5>
                <hr />
            </div>
        </div>
        ...
        <div class="row mb-2">
            <div class="col-lg-12">
                <p class="text-muted">
                    Manage all sectoral goals. Total: <strong>{{ totalCount }}</strong>
                </p>
            </div>
        </div>
        ...
        <div class="row card mb-2">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2 mb-2">
                    <Link :href="route('programs.sectoral-goals.create')" class="btn btn-success w-100">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <tr v-if="goals?.data && goals.data.length === 0">
                        ...
                        <!-- Pagination -->
                        <div v-if="goals?.data && goals.data.length > 0"
                            class="d-flex justify-content-between align-items-center mt-3">
                            <div class="text-muted small">
                                Showing {{ goals.from }} to {{ goals.to }} of {{ goals.total }} entries
                            </div>
                            <nav>
                                <ul class="pagination mb-0">
                                    <li v-for="link in goals.links" :key="link.label"
