...
const steps = [
    { number: 1, label: 'Basic Info',          icon: 'bi-info-circle' },
    { number: 2, label: 'Sectoral Goals',      icon: 'bi-bullseye' },
    { number: 3, label: 'Disaggregations',     icon: 'bi-funnel' },
    { number: 4, label: 'Linked Indicator',    icon: 'bi-link-45deg' },
...
const submit = () => form.post(route('programs.indicators.store'))
