...
const form = useForm({
    ...
    baseline_year: props.pillar.baseline_year,
    target_year: props.pillar.target_year,
    source_document: props.pillar.source_document,
    responsible_entity: props.pillar.responsible_entity,
    presidential_priority_ids: props.pillar.presidential_priorities?.map(p => p.id) || [],
    sectoral_goal_ids: props.pillar.sectoral_goals?.map(g => g.id) || [],
    bond_outcome_ids: props.pillar.bond_outcomes?.map(o => o.id) || [],
})
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input v-model="form.responsible_entity" type="text" class="form-control" 
                                        placeholder="e.g., NLGAS Secretariat" />
