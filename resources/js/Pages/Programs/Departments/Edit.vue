...
const form = useForm({
    ...
    is_technical: props.department.is_technical ?? false,
    is_agency:    props.department.is_agency    ?? false,
    parent_id:    props.department.parent_id    ?? '',
})

const submit = () => form.put(route('programs.departments.update', props.department.id))
</script>
...
<template>
    <BeLayout>
        ...
        <h5 class="mt-4">
            Edit Department
            <span v-if="department.is_agency" class="badge bg-info text-dark ms-2">Agency</span>
        </h5>
        <hr />
            ...
            <div class="col-md-7">
                <div class="card shadow-sm">
                    <div class="card-header card-header-green text-white">
                        <h6 class="mb-0"><i class="bi bi-building me-2"></i>Edit Department</h6>
                    </div>
                    <div class="card-body">
