...
const form = useForm({
    code:          props.bondDeliverable.code,
    deliverable:   props.bondDeliverable.deliverable,
    indicator_ids: [...props.selectedIds],
})
...
const submit = () => form.put(route('programs.bond-deliverables.update', props.bondDeliverable.id))
</script>

<template>
    <BeLayout>
        <Head title="Edit Bond Deliverable" />

        <h5 class="mt-4">
            Edit Bond Deliverable
            <span class="badge bg-success ms-2">{{ bondDeliverable.code }}</span>
        </h5>
        <hr />
            ...
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-header card-header-green text-white">
                        <h6 class="mb-0"><i class="bi bi-bookmark-check me-2"></i>Edit Bond Deliverable</h6>
                    </div>
                    <div class="card-body">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    Linked Indicators
                                    <span class="badge bg-success ms-1">{{ form.indicator_ids.length }} selected</span>
                                </label>
                                <div class="mb-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" :disabled="form.processing">
                                    <i class="bi bi-save me-2"></i>Update Deliverable
                                </button>
                            </div>
                        </form>
                    </div>
