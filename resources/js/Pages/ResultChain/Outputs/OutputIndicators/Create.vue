...
const submit = () => form.post(route('result-chain.output-indicators.store'))
</script>

<template>
    <BeLayout>
        <Head title="Create Output Indicator" />

        <h5 class="mt-4">Create Output Indicator</h5>
        <hr />
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm">
                    <div class="card-header card-header-green text-white">
                        <h6 class="mb-0"><i class="bi bi-graph-up-arrow me-2"></i>New Output Indicator <span class="badge bg-light text-success ms-2">OPT</span></h6>
                    </div>
                    <div class="card-body">
                        <form @submit.prevent="submit">
                            <!-- Code is auto-generated (OPT-{id}) — not shown on create -->
                            <div class="row mb-3">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input v-model="form.measurement_unit" type="text" class="form-control" placeholder="e.g., Number, %" />
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea v-model="form.description" class="form-control" rows="3" placeholder="Describe this indicator..." />
                            </div>

                            <div class="row">
                                <!-- Outcome Indicators (required: min 1) -->
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" :disabled="form.processing">
                                    <i class="bi bi-save me-2"></i>Create Output Indicator
                                </button>
                            </div>
                        </form>
                    </div>
...
.bg-light.text-success { color: rgb(11,109,23) !important; }
