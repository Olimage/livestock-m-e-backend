...
const props = defineProps({ indicator: Object, selectedIds: Array, outcomeIndicators: Array })
...
const submit = () => form.put(route('result-chain.bond-output-indicators.update', props.indicator.id))
</script>

<template>
    <BeLayout>
        <Head title="Edit Bond Output Indicator" />
        <h5 class="mt-4">Edit Bond Output Indicator</h5>
        <hr />
            ...
            <div class="col-lg-9">
                <div class="card shadow-sm">
                    <div class="card-header card-header-green text-white">
                        <h6 class="mb-0"><i class="bi bi-bookmark-check me-2"></i>Edit BOI — <span class="opacity-75">{{ indicator.code }}</span></h6>
                    </div>
                    <div class="card-body">
                        <form @submit.prevent="submit">
                            <div class="mb-2">
                                <label class="form-label">Code</label>
                                <div><span class="badge bg-secondary fs-6">{{ indicator.code }}</span></div>
                            </div>
                            <div class="mb-3 mt-3">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" :disabled="form.processing">
                                    <i class="bi bi-save me-2"></i>Update BOI
                                </button>
                            </div>
                        </form>
                    </div>
