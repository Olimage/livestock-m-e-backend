...
const props = defineProps({ programs: Array, outcomeIndicators: Array })

const form = useForm({
    title: '', description: '', program_id: '', outcome_indicator_ids: [],
})
...
const submit = () => form.post(route('result-chain.program-output-indicators.store'))
</script>

<template>
    <BeLayout>
        <Head title="Create Program Output Indicator" />
        <h5 class="mt-4">Create Program Output Indicator</h5>
        <hr />
            ...
            <div class="col-lg-9">
                <div class="card shadow-sm">
                    <div class="card-header card-header-green text-white">
                        <h6 class="mb-0"><i class="bi bi-folder-check me-2"></i>New PPOI <span class="badge bg-light" style="color:#e65100">PPOI</span></h6>
                    </div>
                    <div class="card-body">
                        <!-- Code is auto-generated (PPOI-{id}) — not shown on create -->
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-3">
                                ...
                                <input v-model="form.title" type="text" class="form-control"
                                    :class="{ 'is-invalid': form.errors.title }" placeholder="Indicator title" required />
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" :disabled="form.processing">
                                    <i class="bi bi-save me-2"></i>Create PPOI
                                </button>
                            </div>
                        </form>
                    </div>
