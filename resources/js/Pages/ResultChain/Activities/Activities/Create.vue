...
const submit = () => form.post(route('result-chain.activities.store'))
</script>
...
<template>
    <BeLayout>
        ...
        <h5 class="mt-4">Create Activity</h5>
        <hr />
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm">
                    <div class="card-header card-header-green text-white">
                        <h6 class="mb-0"><i class="bi bi-lightning me-2"></i>New Activity</h6>
                    </div>
                    <div class="card-body">
                        <form @submit.prevent="submit">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input v-model="form.code" type="text" class="form-control"
                                        ...
                                        placeholder="e.g., ACT-01" required />
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" :disabled="form.processing">
                                    <i class="bi bi-save me-2"></i>Create Activity
                                </button>
                            </div>
                        </form>
                    </div>
